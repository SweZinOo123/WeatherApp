...
/**
 * Created by student on 25/7/15.
 */
// JSON parser is used for converting String which is JSON format into a JSON object or JSON array via getJSONFromUrl() or getJSONArrayFromUrl
